...
La build serve solo a **pubblicare i file dell'app** (`index.html`, `tiles.js`, `og.png`, `_headers`; il font Sono è inline nell'index)
lasciando fuori la `mobile.html` deprecata, `esempi/`, `packs/` e `tools/`.
